...
//0 for deactivate, 1 for gazebo
#define GAZEBO_TEST 0
...
const double FS_MAX_ALT             {50};
const double FS_MAX_KANAN            {0.76};
const double FS_DONE_ALT            {3.0};
const int RC_N_LAND                 {6};
const std::string RC_LAND_PWM       {"HIGH"};
const int RC_N_STAB                 {5};
const std::string RC_STAB_PWM       {"HIGH"};
const int RC_N_EMERGENCY_STOP_MOTOR                 {7};
const std::string RC_STAB_EMERGENCY_STOP_MOTOR       {"HIGH"};
